<x-layout>
    <div>
        <main>
            ...
            <!-- company card -->
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span>
                            <src="{{$job->company->logo}}" alt="{{$job->company->name}}" width="60" height="60" class="rounded-circle flex-shrink-0" />
                        </span>
                    </h4>
                    ...
                    <div class="mt-5">
                        <p>
                            ...
                            <span class="mx-1"> {{ $job->company->headquarters }} </span>
                        </p>
                    </div>

                    <div class="mt-3">
                        <a href="{{$job->company->website}}" class="text-decoration-none">
                            {{ $job->company->name }}
            ...
            <div class="my-5">
                <a href="{{$job->url}}"><button type="button" class="btn btn-danger">
                        Apply to this job
                    </button></a>
            </div>
